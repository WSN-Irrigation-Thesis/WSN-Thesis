 ...
 * This class implements a Java interface to the 'BaseSerialMsg'
 * message type.
 */

public class BaseSerialMsg extends net.tinyos.message.Message {
    ...
    /** Create a new BaseSerialMsg of size 4. */
    public BaseSerialMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new BaseSerialMsg of the given data_length. */
    public BaseSerialMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BaseSerialMsg with the given data_length
     * and base offset.
     */
    public BaseSerialMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BaseSerialMsg using the given byte array
     * as backing store.
     */
    public BaseSerialMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public BaseSerialMsg(byte[] data, int base_offset) {
     ...
     */
    public BaseSerialMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BaseSerialMsg embedded in the given message
     * at the given base offset.
     */
    public BaseSerialMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public BaseSerialMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <BaseSerialMsg> \n";
      try {
